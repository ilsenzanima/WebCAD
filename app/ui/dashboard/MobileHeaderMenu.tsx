...
import { OverviewIcon, ExpensesIcon, SchedulesIcon, SettingsIcon, CalendarIcon, TagIcon, SupplierIcon } from "./icons";
...
export default function MobileHeaderMenu({ initials, userName, userEmail }: MobileHeaderMenuProps) {
  ...
  const navItems = [
    ...
    { href: "/dashboard/expenses", icon: <ExpensesIcon size={14} />, label: "Spese & Entrate" },
