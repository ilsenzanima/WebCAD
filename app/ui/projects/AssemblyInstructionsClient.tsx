  ...
  const steps = useMemo(() => {
    ...
    if (itemType === "dritte") {
      ...
      return [
        ...
        {
          num: 4,
          title: "🔒 Chiusura Canale Dritto (Fronte SX)",
          desc: `Monta la lastra frontale sinistra intera da ${(widthCm + 2 * thicknessCm).toFixed(1)} cm per chiudere ermeticamente il canale dritto. *IMPORTANTE: Incollare e avvitare.*`,
          materials: [
            `1x Lastra Frontale SX (Intera): ${(widthCm + 2 * thicknessCm).toFixed(1)} x ${lengthCm} cm (Spessore: ${thicknessMm} mm)`,
            "Viti e collante tagliafuoco"
          ],
        },
        {
                ...
                {itemType === "dritte" ? (
                  ...
                  <>
                    <div className="flex justify-between font-bold text-white mb-0.5">
                      <span>• Struttura Canali:</span>
                    </div>
                    <div className="flex justify-between pl-2">
                      <span>- 1x Schiena SX (Dritto):</span>
