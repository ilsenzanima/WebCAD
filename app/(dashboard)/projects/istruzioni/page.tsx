  ...
  const categories = [
    {
      ...
      desc: "Istruzioni di montaggio 3D interattive e parametriche per canalizzazioni (orizzontali e verticali), con opzione con giunto esterno o a giunti sfalsati.",
      badge: "Disponibile",
    ...
    {
      id: "pareti-contropareti",
      title: "🧱 Pareti e Contropareti",
      desc: "Istruzioni di montaggio per pareti e contropareti antincendio a secco in silicato o cartongesso.",
      badge: "Soon",
      href: "#",
      active: false,
    },
    {
      id: "soffitti-controsoffitti",
      title: "🏛️ Soffitti e Controsoffitti",
      desc: "Istruzioni di montaggio per soffitti, controsoffitti e membrane di protezione antincendio.",
      badge: "Soon",
      href: "#",
      active: false,
    },
